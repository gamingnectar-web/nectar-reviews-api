...
const required = [
  ...
  'src/routes/aiEmailModules.js',
  'src/routes/emailModuleLibrary.js',
  ...
  'public/admin-ai-module-builder.js',
...
console.log('Restore verification passed. Legacy v25 logic plus AI modules and migration centre are present.');
