...
const env = {
  ...
  shopifyScopes: process.env.SHOPIFY_SCOPES || 'read_products,write_products,read_inventory,write_inventory,read_customers,read_orders,write_files,read_webhooks,write_webhooks',
