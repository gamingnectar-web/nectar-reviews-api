...
const reviewRequestJobSchema = new mongoose.Schema({
  ...
  orderCreatedAt: { type: Date, default: null, index: true },
  fulfilledAt: { type: Date, default: Date.now },
  deliveredAt: { type: Date, default: null },
  lastDeliveryCheckAt: { type: Date, default: null, index: true },
  deliveryStatus: { type: String, default: '' },
  deliverySource: { type: String, default: '' },
  deliveryTracking: { type: [mongoose.Schema.Types.Mixed], default: [] },
