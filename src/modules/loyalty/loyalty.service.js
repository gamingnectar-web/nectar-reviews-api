...
function defaultLoyaltyConfig(shopDomain) {
  return {
    ...
    emailModuleLibrary: [
      ...
      { id: 'module_support', name: 'Support note', type: 'support', title: 'Need help?', body: 'Reply to this email if you need anything.', backgroundEnabled: true, backgroundColor: '#f8fafc', backgroundOpacity: 100, borderEnabled: true, borderColor: '#e5e7eb', borderWidth: 1, radius: 16, padding: 16, position: 'after_body', alignment: 'left' },
    ],
    emailTemplates: [{ id: 'loyalty_email_primary', name: 'Reward ready', primary: true, status: 'primary', subject: 'Your reward is ready', heading: 'Your reward is ready', subtitle: 'Your loyalty reward is ready to use.', body: 'Thanks for being part of our rewards programme. Your {{ reward_type }} is now ready.', modules: [{ id: 'module_reward_box', name: 'Reward box', type: 'reward_box', title: 'Reward unlocked', body: 'Use your reward on your next order.', backgroundEnabled: true, backgroundColor: '#f8fafc', backgroundOpacity: 100, borderEnabled: true, borderColor: '#e5e7eb', borderWidth: 1, radius: 16, padding: 16, position: 'after_body', alignment: 'left' }], accentColor: '#111827', buttonText: 'Shop now' }],
...
function cleanEmailModule(input = {}) {
  return {
    ...
    backgroundOpacity: clampNumber(input.backgroundOpacity, 0, 100, 100),
    borderEnabled: input.borderEnabled !== false,
