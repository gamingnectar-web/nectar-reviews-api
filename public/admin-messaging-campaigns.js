    ...
    return `
      <div class="msg-shell">
        ...
        <section id="msg-pane-analytics" class="msg-pane">
          <div class="msg-card"><h3>Campaign analytics</h3><p>Open/click tracking by campaign, including test emails.</p><div id="msg-analytics" class="msg-analytics"><div><span>Sent</span><strong>0</strong></div><div><span>Open rate</span><strong>0%</strong></div><div><span>Click rate</span><strong>0%</strong></div></div><div id="msg-analytics-breakdown" class="msg-link-rule-list" style="margin-top:16px;"></div></div>
        </section>
