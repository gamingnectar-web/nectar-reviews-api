(function Elev8ManualReviewImport(){
  ...
  style.textContent=`
    ...
    .mr-stars{display:flex;gap:3px}.mr-stars button{border:0;background:none;padding:0;font-size:27px;color:#d8dde5;cursor:pointer}.mr-stars button.on{color:#ffb400}.mr-product-search-wrap{position:relative}.mr-product-results{display:none;position:absolute;left:0;right:0;top:100%;z-index:10;background:#fff;border:1px solid #d8dee7;border-radius:10px;box-shadow:0 12px 30px rgba(0,0,0,.12);max-height:260px;overflow:auto}.mr-product-results.open{display:block}.mr-result{width:100%;border:0;background:#fff;padding:9px;text-align:left;display:flex;gap:9px;align-items:center;cursor:pointer;border-bottom:1px solid #eef1f4}.mr-result img{width:42px;height:42px;object-fit:cover;border-radius:7px}.mr-result span{display:flex;flex-direction:column}.mr-result small,.muted{color:#7b8493}
    .mr-attributes{margin-top:14px;border-top:1px solid #edf0f4;padding-top:14px}.mr-attributes>strong{font-size:13px}.mr-attributes small{font-weight:500;color:#7b8493}.mr-attr-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:10px}.mr-attr-grid input{padding:0;border:0}.mr-foot{background:#fff;border-top:1px solid #e5e9ef;padding:14px 18px;display:flex;justify-content:space-between;align-items:center;gap:12px}.mr-foot>div{display:flex;gap:8px}.mr-foot .ok{color:#167642;font-weight:700}.mr-foot .error{color:#a72b20;font-weight:700}
